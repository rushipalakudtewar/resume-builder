...
const Dashboard = () => {
  ...
  return (
    ...
    <div className="home-container">
      {/* <Helmet>
        <title>Angelic Diligent Crow</title>
        <meta property="og:title" content="Angelic Diligent Crow" />
      </Helmet> */}
      ...
      <div className="home-details">
        ...
        <div>
              <img
                alt="image"
                src='https://images.pexels.com/photos/968631/pexels-photo-968631.jpeg?auto=compress&cs=tinysrgb&w=600'
                className="home-details-image"
              />
          </div>
          <div className="home-container02 ml-10" >
            <span className="home-text sectionTitle">
      ...
      <div className="home-footer">
        ...
        <div className='flex justify-between items-center px-4 md:px-10 flex-col md:flex-row pt-10 md:pt-0'>
          <div className='w-full md:w-1/2 '>
            <h1 className='font-bold text-4xl md:text-6xl'>Build a professional resume for free</h1>
            <p className='text-lg mt-5 font-semibold'>Create your resume easily with our free builder and professional templates.</p>
            <button className='px-6 py-3 mt-5 border-none font-bold text-white bg-red-500 hover:bg-red-700' onClick={handleCreateResume}>Create My Resume</button>
          </div>
          <div className='w-full md:w-1/2 mt-3 md:mt-0'>
            <img src={resume1} alt='img1' className='w-full h-[300px] md:h-[600px] object-cover'/>
          </div>

        </div> 
       
        <div className='flex justify-between items-center px-4 md:px-10 flex-col md:flex-row bg-slate-800 text-white pt-10 md:pt-0'>
          <div className='w-full md:w-1/2'>
            <img src={resume1} alt='img1' className='w-full h-[300px] md:h-[600px] object-cover'/>
          </div>
          <div className='flex flex-col w-full md:w-1/2 mx-2'>
            <p className='flex items-center text-2xl mt-4'><IoCheckmarkDoneSharp className='text-2xl text-red-700 mr-4'/>30+ Professional Resume Templates</p>
            <p className='ml-10 text-md'>Choose from over 30 modern and professional templates, all of which can be customized to your liking.</p>
            <p className='flex items-center text-2xl mt-4'><IoCheckmarkDoneSharp className='text-2xl text-red-700 mr-4'/>Premium Feature: PDF Resume Downloads</p>
            <p className='ml-10 text-md'>Download your resume and send it straight to the hiring manager. Whatever format you choose, we’ve got you covered. TXT downloads are available for free for all users.</p>
            <p className='flex items-center text-2xl mt-4'><IoCheckmarkDoneSharp className='text-2xl text-red-700 mr-4'/>Robust Text Editor</p>
            <p className='ml-10 text-md'>Our text editor has everything you need to customize your resume. Choose different fonts, sizes, bullets, and much more.</p>
            <p className='flex items-center text-2xl mt-4'><IoCheckmarkDoneSharp className='text-2xl text-red-700 mr-4'/>Fast, Easy to Use, and Free to Start</p>
            <p className='ml-10 text-md'>Our resume builder lets you easily and quickly create this important document using our resume wizard.</p>
          </div>
